...
Module common
    ...
    '
    Public Const rnPastPositionID = "fld1"
    ...
    Public Const adminInstructions = "" _
        ...
        & cr & "<p>Use this addon to create an election where each visitor can vote for one candidate for each of one or more positions. A visitor can only vote once.</p>" _
        & cr & "<ol>" _
        ...
        & cr2 & "<li><p>Create voting postions for each voting category, like 'President' and 'Vice President'.</p></li>" _
        & cr2 & "<li><p>Make sure each person running for a position has a Member record in the system. (Members are People records where Member is selected in the content tab.)</p></li>" _
        & cr2 & "<li><p>Create a candidate entry for each candidate, selecting the appropriate member.</p></li>" _
        & cr & "</ol>"
End Module
